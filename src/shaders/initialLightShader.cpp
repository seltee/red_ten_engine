...
#include "initialLightShader.h"
#include "opengl/glew.h"
#include "math/math.h"
#include "math/glm/gtc/type_ptr.hpp"

const char *InitialLightShader::internalVertexShader =
    "#version 410 core\n"
...
const char *InitialLightShader::internalFragmentShader =
    "#version 410 core\n"
    "out vec4 FragColor;\n"
    "in vec2 texCoord;\n"
    ...
    "   float Roughness = texture(tAlbedo, texCoord).a;\n"
    ...
    "   vec3 Diffuse = (IrradianceBlured * blurRadianceFactor + IrradianceFull * fullRadianceFactor + vf3ambientColor) * Albedo;\n"
    "   vec3 Ambient = (kD * Diffuse) * AO;\n"
    "   FragColor = length(Normal) == 0 ? vec4(0.0, 0.0, 0.0, 0.0) : vec4(Ambient, 1.0);\n"
    "}\n";

InitialLightShader::InitialLightShader() : RawShader(internalVertexShader, internalFragmentShader)
{
    build();
...
void InitialLightShader::setTextureAlbedo(unsigned int albedoID)
{
...
void InitialLightShader::setTextureNormal(unsigned int normalID)
{
...
void InitialLightShader::setTexturePosition(unsigned int positionID)
{
...
void InitialLightShader::setTextureRadiance(unsigned int radianceID)
{
...
void InitialLightShader::setTextureEnvironment(unsigned int environmentID)
{
...
void InitialLightShader::setCameraPosition(Vector3 &position)
{
    glUniform3fv(locCameraPosition, 1, value_ptr(position));
}

void InitialLightShader::setAmbientColor(float *ambientColor)
{
